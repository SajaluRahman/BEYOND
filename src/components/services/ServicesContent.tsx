...
const services = [
  ...
  },
  {
    ...
    description: "Cinematic wedding photography and videography that captures every emotion, every detail, every unforgettable moment.",
    href: "/services/wedding-videography-and-photography",
    accent: "#e11d48",
    icon: "📸",
  },
];
